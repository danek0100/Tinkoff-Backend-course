...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> DESCRIPTION = createField(DSL.name("DESCRIPTION"), SQLDataType.VARCHAR(1000000000), this, "");
    ...
    /**
     * The column <code>LINK.LAST_UPDATE_TIME</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATE_TIME = createField(DSL.name("LAST_UPDATE_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
